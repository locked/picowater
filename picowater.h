...
#define EXT_GPIO_PIN 21

#define EXT_POWER_PIN 1

#define SCREEN_SDA_PIN 2     // 2 for 1.0, 18 for v0.9
#define SCREEN_SCL_PIN 3     // 3 for 1.0, 19 for v0.9
...
#define PUMP_PIN 18          // 18 for 1.0, 27 for v0.9, 21 for v0.3, 4 for v0.2
